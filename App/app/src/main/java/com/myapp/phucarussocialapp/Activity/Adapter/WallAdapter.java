...
public class WallAdapter extends BaseAdapter {
    ...
    public WallAdapter(Context context, ArrayList<Post> statusList, int layout1, int layout2) {
        ...
        if (post.getImg().equals("none") == true) {
            ...
            avt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("user_uid", post.getUid());
                    intent.putExtra("user_name", post.getName());
                    intent.putExtra("user_avt", post.getAvt());
