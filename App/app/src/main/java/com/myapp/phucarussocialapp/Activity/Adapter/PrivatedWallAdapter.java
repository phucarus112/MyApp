...
public class PrivatedWallAdapter extends BaseAdapter {

    Context context;
    ArrayList<Post> statusList;
    int layout1, layout2;

    public PrivatedWallAdapter(Context context, ArrayList<Post> statusList, int layout1, int layout2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final Post post = statusList.get(position);
        ...
        if (post.getImg().equals("none") == true) {
            ...
            TextView count_like = (TextView) convertView.findViewById(R.id.post_tv_tym_no_img);
           ...
           tym.setOnClickListener(new View.OnClickListener() {
            ...
            TextView caption = (TextView) convertView.findViewById(R.id.post_caption);
            ...
            TextView count_like = (TextView)convertView.findViewById(R.id.post_tv_tym);
    ...
    private void showDialog(final Post temp) {
        ...
        CommentAdapter commentAdapter = new CommentAdapter(context,commentArrayList,R.layout.row_comment);
    ...
    private void deletePost(String time) {
        ...
        ProfileActivity.privatedWallAdapter.notifyDataSetChanged();
